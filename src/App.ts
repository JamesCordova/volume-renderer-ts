...
`,
        ...
        // Subida DICOM/RAW ya no vive aca -- son React ahora (ver
        // src/ui/store/upload.ts y src/ui/components/Upload{Dicom,Raw}.tsx),
        // con progreso real (barra determinada durante la subida de
        // archivos y el processing_percent del backend, no solo un texto).
        // Misma logica exacta, solo movida.
